...
mboot:
  ...
  dd 0, 0, 0, 0, 0 ; honestly idk
  dd 0 ; 0: Graphics, 1: Text
  dd 1600 ; width
  dd 1200 ; height
  dd 8 ; depth
  ...
  dd  bss                       ; End of kernel '.types' section.
...
start:
;  push esp ; Push the stack pointer (important for setting up our own allocated stack)
